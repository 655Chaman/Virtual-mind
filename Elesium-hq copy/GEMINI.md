...
Subagents are lightweight agents (Sonnet 4.5) with self-contained contexts, defined in `agents/`. They're cheaper, unbiased (no parent context leakage), and keep the parent context clean.
...
```bash
python3 skills/scrape-leads/scripts/scrape_apify.py ...
```
...
- `modal/` - Modal app template for n8n endpoints
- `antigravity/` - Outreach knowledge base (prompts, workflows, settings)
- `google-sheets-mcp/` - Google Sheets MCP server + Make/n8n blueprints
- `.agent/workflows/` - Quick-reference workflow guides
...
## ⚡ Elesium Mind — Operating System

The Elesium Mind is a 5-file knowledge system in `antigravity/elesium_mind/`. It defines WHO you are, HOW you think, and WHAT you know when operating for Chaman Shah / Elesium.

**Always read `antigravity/elesium_mind/elesium_mind.md` first** — it's the master brain that routes you to the right branch file.

| File | Purpose | When to Read |
|------|---------|--------------||
| [`elesium_mind.md`](antigravity/elesium_mind/elesium_mind.md) | Identity, decision framework, operating principles, hard rules | Every session — this is your OS |
| [`signals.md`](antigravity/elesium_mind/signals.md) | Pain-sniffing method, 3 tactics, LinkedIn queries, signal matrix | Finding leads, identifying pain |
| [`arsenal.md`](antigravity/elesium_mind/arsenal.md) | All 31 prompt templates by category (openers → LinkedIn DMs) | Writing any outreach message |
| [`playbooks.md`](antigravity/elesium_mind/playbooks.md) | 4 workflow playbooks with flow diagrams, schemas, AI configs | Running any end-to-end campaign |
| [`forge.md`](antigravity/elesium_mind/forge.md) | Tool stack, swap table, AI settings, common bugs, build rules | Building or configuring anything |
